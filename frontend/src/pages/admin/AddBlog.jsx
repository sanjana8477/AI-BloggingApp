...
const AddBlog = () => {
  ...
  //when we click on add button it will take some time to add the blog data  from the database using api
  // until then we will show a adding... loading state , disable add button
  ...
  const generateContent = async()=>{
    ...
    try{
      ...
      if(data.success){
        quillRef.current.root.innerHTML = parse(data.content)   // parse ise used to store the html content in quill editor
      }else{
        toast.error(data.message)
      }
    }catch(error){
